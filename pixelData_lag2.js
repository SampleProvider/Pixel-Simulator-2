...
var pixels = {
                ...
                if (moveRandom > 0.5) {
                    if (y != 0) {
                        if (grid[y - 1][x][1] != "frost_fire") {
                            if (move(x, y, [{ x: 0, y: -1 }], 1)) {
                                if (grid[y][x][1] == "air" && getRandom() < 0.5) {
                                    grid[y][x][1] = "frost_fire";
                                }
                            }
                        }
                    }
    ...
    "penetrator_left": {
        ...
        update: function(x, y) {
            ...
            if (grid[y][x - 1][0] == null) {
                leftPixel[0] = grid[y][x - 1][0];
            }
            if (grid[y][x - 1][1] == null) {
            ...
            if (rightPixel[0] == "air" && rightPixel[1] == "air") {
                grid[y][x - 1] = ["air", "air"];
                grid[y][x - 1] = [null, null];
                grid[y][x + 1] = leftPixel;
            }
            push(x + 1, y, "left", gridSize, true);
        },
        updateStage: 1,
    ...
    "penetrator_up": {
        ...
        update: function(x, y) {
            ...
            if (belowPixel[0] == "air" && belowPixel[1] == "air") {
                grid[y - 1][x] = ["air", "air"];
                grid[y - 1][x] = [null, null];
                grid[y + 1][x] = abovePixel;
            }
            push(x, y + 1, "up", gridSize, true);
        },
        updateStage: 1,
    ...
    "rotator_clockwise": {
        ...
        update: function(x, y) {
            ...
            forAllTouching(x, y, function(x1, y1) {
                if (grid[y1][x1][0] != null) {
                    if (grid[y1][x1][0].includes("_left")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_left", "_up");
                    }
                    else if (grid[y1][x1][0].includes("_up")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_up", "_right");
                    }
                    else if (grid[y1][x1][0].includes("_right")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_right", "_down");
                    }
                    else if (grid[y1][x1][0].includes("_down")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_down", "_left");
                    }
                    else if (grid[y1][x1][0].includes("_horizontal")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_horizontal", "_vertical");
                    }
                    else if (grid[y1][x1][0].includes("_vertical")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_vertical", "_horizontal");
                    }
                }
                else {
                    if (grid[y1][x1][0].includes("_left")) {
    ...
    "rotator_counter_clockwise": {
        ...
        update: function(x, y) {
            ...
            forAllTouching(x, y, function(x1, y1) {
                if (grid[y1][x1][0] != null) {
                    if (grid[y1][x1][0].includes("_left")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_left", "_down");
                    }
                    else if (grid[y1][x1][0].includes("_down")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_down", "_right");
                    }
                    else if (grid[y1][x1][0].includes("_right")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_right", "_up");
                    }
                    else if (grid[y1][x1][0].includes("_up")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_up", "_left");
                    }
                    else if (grid[y1][x1][0].includes("_horizontal")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_horizontal", "_vertical");
                    }
    ...
    "alternator": {
        ...
        update: function(x, y) {
            ...
            forAllTouching(x, y, function(x1, y1) {
                if (grid[y1][x1][0] != null) {
                    if (grid[y1][x1][0].includes("_left")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_left", "_right");
                    }
                    else if (grid[y1][x1][0].includes("_right")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_right", "_left");
                    }
                    else if (grid[y1][x1][0].includes("_up")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_up", "_down");
                    }
                    else if (grid[y1][x1][0].includes("_down")) {
                        grid[y1][x1][0] = grid[y1][x1][0].replace("_down", "_up");
                    }
                }
                else {
                    if (grid[y1][x1][0].includes("_left")) {
