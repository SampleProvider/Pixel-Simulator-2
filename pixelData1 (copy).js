var pixels = {
    ...
    "sapling": {
        ...
        update: function(x, y) {
            ...
            if (y != gridSize - 1 && getRandom() < 0.01) {
                if (isPixel(grid[y + 1][x], "dirt", null)) {
                    var direction = [0, -1];
                ...
                if (isPixel(grid[y + 1][x], "grass", null)) {
                    var direction = [0, -1];
                ...
                if (isPixel(grid[y + 1][x], "sand", null)) {
                    var direction = [0, -1];
                ...
                if (isPixel(grid[y + 1][x], "mud", null)) {
                    var direction = [0, -1];
    ...
    "lava": {
        ...
        update: function(x, y) {
            ...
            forAllTouchingDiagonal(x, y, function(x1, y1) {
                if (isPixel(grid[y1][x1], "water", null)) {
                    if (y1 > y) {
                        if (touchingLava >= 5) {
                ...
                if (isPixel(grid[y1][x1], "grass", null)) {
                    changePixel(x1, y1, "dirt", null);
                }
                if (!isPixel(grid[y1][x1], "lava", null) && getRandom() < 0.1) {
    ...
    "fire": {
        ...
        update: function(x, y) {
            if (numberedPixels[grid[y][x][0]].flammable == 0 || isPixel(x, y, "lava", null)) {
            ...
            if (numberedPixels[grid[y][x][0]].flammable < 0 && getRandom() < -1 / numberedPixels[grid[y][x][0]].flammable) {
                changePixel(x, y, null, "air");
                return;
            }
            ...
            if (getRandom() < 1 / (numberedPixels[grid[y][x][0]].flammable * 10)) {
                if (getRandom() < 0.25) {
            ...
            forAllTouchingDiagonal(x, y, function(x1, y1) {
                if (numberedPixels[grid[y1][x1][0]].flammable == 0) {
                    if (getRandom() < 0.05) {
                        changePixel(x, y, null, "air");
                        if (isPixel(x1, y1, "water", null)) {
                            changePixel(x1, y1, "steam", null);
                        }
                    }
                }
                else if (!isPixel(x1, y1, null, "fire") && numberedPixels[grid[y1][x1][0]].flammable > 0 && getRandom() < 1 / numberedPixels[grid[y1][x1][0]].flammable) {
                    changePixel(x1, y1, null, "fire");
                }
            });
            ...
            if (moveRandom > 0.5) {
                if (y != 0) {
                    if (!isPixel(x, y - 1, null, "fire") && (numberedPixels[grid[y - 1][x][0]].flammable > 0 || isPixel(x, y - 1, "air", null)) && getRandom() < 5 / Math.abs(numberedPixels[grid[y - 1][x][0]].flammable)) {
                        if (move(x, y, [{ x: 0, y: -1 }], 1)) {
                            if (getRandom() < numberedPixels[grid[y][x][0]].flammable > 0 ? 0.75 : 0.25) {
                                nextGrid[y][x][1] = "fire";
                            }
                        }
                    }
    ...
    "steam": {
        ...
        update: function(x, y) {
            ...
            var burned = false;
            forAllTouchingDiagonal(x, y, function(x1, y1) {
                if (!isPixel(x1, y1, null, "fire") && numberedPixels[grid[y1][x1][0]].flammable > 0 && getRandom() < 1 / numberedPixels[grid[y1][x1][0]].flammable) {
                    burned = true;
                    changePixel(x1, y1, null, "fire");
                }
            });
    ...
    "snow": {
        ...
        update: function(x, y) {
            if (isTouchingDiagonal(x, y, "lava", null) || isTouchingDiagonal(x, y, null, "fire") || isPixel(x, y, null, "fire") {
                changePixel(x, y, "water", null);
                return;
            }
    ...
    "ice": {
        ...
        update: function(x, y) {
            ...
            forAllTouchingDiagonal(x, y, function(x1, y1) {
                if (isPixel(x1, y1, null, "air") && !isPixel(x1, y1, "ice", null) && getRandom() < 0.1) {
